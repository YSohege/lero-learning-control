...
from lero_control_gym.envs.constraints import ConstraintList, GENERAL_CONSTRAINTS, create_constraint_list
...
class RBCMPC(BaseController):
    ...
    def setup_optimizer(self):
        ...
        for controller in range(self.numberControllers):
            ...
            # Reference (equilibrium point or trajectory, last step for
            # terminal cost).
