...
class RBCPID(BaseController):
    ...
    def step(self, action):
        ...
        # Blended RPM commands from all Attitude controllers based on action
        # input
        ...
        self.info['condensedObs'] = [
            self.info['mse'], roll_err, pitch_err, yaw_err]
    ...
    def _supervisoryControl(self, rpms):
        self.Blend = self.AttitudeControllerDistribution.rvs(self.alpha, size=1)[
            0]
