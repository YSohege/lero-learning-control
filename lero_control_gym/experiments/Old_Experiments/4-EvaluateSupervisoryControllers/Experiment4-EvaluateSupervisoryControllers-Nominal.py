...
class Experiment():
    ...
    def run(self):
        ...
        for i in range(self.generalConfig.number_iterations):
            ...
            print("Opt Switching mean, std - " +
                  str(self.optimal_mmac_pid_0.SWITCH_DELAY) + " delay ")
            print(np.mean(OptSwitch0))
            print(np.std(OptSwitch0))

            print("Opt Switching mean, std -  " +
                  str(self.optimal_mmac_pid_1.SWITCH_DELAY) + " delay ")
            print(np.mean(OptSwitch1))
            print(np.std(OptSwitch1))

            print("Opt Switching mean, std -  " +
                  str(self.optimal_mmac_pid_2.SWITCH_DELAY) + " delay ")
            print(np.mean(OptSwitch2))
            print(np.std(OptSwitch2))

            print("Opt Switching mean, std - " +
                  str(self.optimal_mmac_pid_3.SWITCH_DELAY) + " delay ")
            ...
            print(
                np.average(
                    NN_average_output[0]), np.average(
                    NN_average_output[1]))
            ...
            print("-------------" + str(i + 1) + "/" +
                  str(self.generalConfig.number_iterations) + "----------")
