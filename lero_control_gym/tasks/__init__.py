...
register(id="Quadcopter3D_Optimal_Switching",
...
#AAAI Experimental Tasks

register(id="AAAI_23_Quadcopter3D_Optimal_Switching",
         entry_point="lero_control_gym.tasks.AAAI_23.Quadcopter3D_Optimal_Switching.Quadcopter3D_Optimal_Switching:Task",
         config_entry_point="lero_control_gym.tasks.AAAI_23.Quadcopter3D_Optimal_Switching:Quadcopter3D_Optimal_Switching.yaml")

register(id="AAAI_23_Quadcopter3D_Uniform_RBC",
         entry_point="lero_control_gym.tasks.AAAI_23.Quadcopter3D_Uniform_RBC.Quadcopter3D_Uniform_RBC:Task",
         config_entry_point="lero_control_gym.tasks.AAAI_23.Quadcopter3D_Uniform_RBC:Quadcopter3D_Uniform_RBC.yaml")
