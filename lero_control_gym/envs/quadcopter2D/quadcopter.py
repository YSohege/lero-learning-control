...
from lero_control_gym.envs.benchmark_env import Cost, Task
from lero_control_gym.envs.constraints import GENERAL_CONSTRAINTS, create_constraint_list
from lero_control_gym.math_and_models.symbolic_systems import SymbolicModel
from lero_control_gym.envs.quadcopter2D.base_aviary import BaseAviary
from lero_control_gym.envs.quadcopter2D.quadcopter_utils import QuadType, cmd2pwm, pwm2rpm
from lero_control_gym.math_and_models.normalization import normalize_angle


class Quadcopter(BaseAviary):
